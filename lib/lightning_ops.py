...
"""
TO KARL:
THIS IS PROBABLY THE MOST HELPFUL CODE
IT CONNECTS TO THE LIGHTNING DAEMON AND CONNECTS TO ONE OR MORE NODES
ASKS THEM FOR THE NODES THEY KNOW AND CONVERTS IT TO A GRAPH IN NETWORKX FORMAT
WHICH MAY BE USED FOR ANALYSIS AND EVERYTHING
