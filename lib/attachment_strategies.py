...
THESE where used internally in my simulation when nodes opened channels,

The selection algorithms may be useful down the line, although they are cluttered with junk.
