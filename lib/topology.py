...
"""
TO KARL: THIS MAY BE NICE ALSO TO EVALUATE ALGORTIHMS BASED ON HOW THE NETWORK LOOKS LIKE
READ THE PAPERS ON RANDOM NETWORK BY ERDOS AND RENYI AND Barabasi and ALBERTs PAPER.

ALGORITHMS MAY PERFORM DIFFIRENTI DEPENDENT ON WHERE IN THE NETWORK THE CHANNEL IS AND WHICH TOPOLOGY THE NETWORK
HAVE.
"""
